...
package scopeToHdmi_package is
	...
	constant M_HORZ: STD_LOGIC_VECTOR(VIDEO_WIDTH_IN_BITS-1 downto 0) := std_logic_vector(to_unsigned(640, VIDEO_WIDTH_IN_BITS));
    ...
    -- constant SIGNAL_LINE_WIDTH: STD_LOGIC_VECTOR(VIDEO_WIDTH_IN_BITS-1 downto 0) := std_logic_vector(to_unsigned(7, VIDEO_WIDTH_IN_BITS));
